...
~/Qt/5.15.2/*/bin/macdeployqt ~/Desktop/BuzzBot/App/BuzzBot.app -always-overwrite -appstore-compliant
...
xcrun altool --validate-app -f ~/Desktop/BuzzBot/BuzzBot-Installer.pkg --type osx --primary-bundle-id "com.rwardrup.buzzbot" -u "rosswardrup@hotmail.com" -p "fipi-imfi-uadn-xubp"

echo "Uncomment xcrun altool --upload-app to upload to app store."
#xcrun altool --upload-app --type osx --file ~/Desktop/BuzzBot/Buzzbot-Installer.pkg --primary-bundle-id "com.rwardrup.buzzbot" --username "rosswardrup@hotmail.com" -p "fipi-imfi-uadn-xubp"
