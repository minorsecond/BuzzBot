...
echo "Codesigning."
find ~/Desktop/Beertabs.app -name "*.dylib" | xargs -I $ codesign --options runtime --verify --verbose --sign $1 $
find ~/Desktop/Beertabs.app -name "*.framework" | xargs -I $ codesign --options runtime --verify --verbose --sign $1 $
